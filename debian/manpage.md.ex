% json-toolkit(SECTION) | User Commands
%
% "April 10 2023"
...
json-toolkit - program to do something

# SYNOPSIS

**json-toolkit** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**json-toolkit** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **json-toolkit** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**json-toolkit** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    json-toolkit. See **foo.conf**(5) for further details.
...
**json-toolkit** provides some return codes, that can be used in scripts:
...
Tyler Adams <tyler@blitzblitzblitz.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Tyler Adams
